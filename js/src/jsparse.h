...
struct JSParseNode {
    ...
    int8                pn_arity;
    JSTokenPos          pn_pos;
    uintN               pn_parens;      /* cover grammar: 0, 1, or nested */
    uint8               pn_grammar_flags; /* grammar category retained by folding */
...
#define PNGF_NOT_LHS       0x01U /* expression grammar is not LeftHandSide */
