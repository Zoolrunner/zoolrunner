...
{
    // The supported little-endian AAPCS64 ABI stores narrow scalars at
    // the low address of an eight-byte stack slot.
    memcpy(result, stack, sizeof(T));
    stack = (char*)stack + sizeof(PRUint64);
}
...
__asm__(".text\n\t"                                                    \
        ...
        ".size _ZN14nsXPTCStubBase5Stub" #n "Ev, 8\n\t" \
        "_ZN14nsXPTCStubBase5Stub" #n "Ev:\n\t"                       \
        ".elseif " #n " < 100\n\t"                                   \
        ".globl _ZN14nsXPTCStubBase6Stub" #n "Ev\n\t"                \
        ".type _ZN14nsXPTCStubBase6Stub" #n "Ev, %function\n\t" \
        ".size _ZN14nsXPTCStubBase6Stub" #n "Ev, 8\n\t" \
        "_ZN14nsXPTCStubBase6Stub" #n "Ev:\n\t"                       \
        ".elseif " #n " < 1000\n\t"                                  \
        ".globl _ZN14nsXPTCStubBase7Stub" #n "Ev\n\t"                \
        ".type _ZN14nsXPTCStubBase7Stub" #n "Ev, %function\n\t" \
        ".size _ZN14nsXPTCStubBase7Stub" #n "Ev, 8\n\t" \
        "_ZN14nsXPTCStubBase7Stub" #n "Ev:\n\t"                       \
        ".else\n\t.err \"stub number too large\"\n\t.endif\n\t"          \
        "mov w17, #" #n "\n\tb SharedStub\n\t");
#else
#error "Unsupported C++ ABI for Linux AArch64 LP64 xptcall."
#endif
