...
| Linux i686 / x86_64 | Both GTK2 and Xlib have profiles and CI jobs for all four applications. Isolated x86_64 GTK2 and Xlib Suite rebuilds pass the packaged runtime checks, including Venkman lifecycle and ChatZilla, with the GCC and Xlib queue fixes. A fresh x86_64 Xlib Suite build compiles and packages. | Full fresh-build and runtime matrix validation remains in progress; see the [Linux status](build/linux/README.md). |
