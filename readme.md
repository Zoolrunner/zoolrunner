...
| Linux i686 / x86_64 | Both GTK2 and Xlib have profiles and CI jobs for all four applications. An existing x86_64 GTK2 Suite package passes shell, embedding, Expat, navigation, and window-bootstrap rechecks. | That package exits with code 11 during Venkman lifecycle testing. Full fresh-build and runtime matrix validation remains in progress; see the [Linux status](build/linux/README.md). |
