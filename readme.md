...
| Windows x86 | Suite and Browser pass complete local MSVC2005/Wine `act` workflows; Suite and XULRunner also pass the GitHub-hosted build, package, audit, runtime and upload jobs. A separate September 16 Suite package passes 17 regression groups in NT 4.0, Me, and 2000 guests. | The new Wine-tested package has not been revalidated on original Windows releases. Windows 95 blockers and the corrected Calendar workflow rerun remain open; see the [Windows build guide](build/win32/msvc8-cross/README.md). |
