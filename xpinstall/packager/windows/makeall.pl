...
$inInstName               = "zoolrunner-win32-installer"      if !defined($inInstName);
$inStubName               = "zoolrunner-win32-stub-installer" if !defined($inStubName);

$seiFileNameGeneric       = "nsinstall.exe";
$seiFileNameSpecific      = "$inInstName.exe";
$seiStubRootName          = $inStubName;
$seiFileNameSpecificStub  = "$seiStubRootName.exe";
$seuFileNameSpecific      = "zoolrunnerUninstall.exe";
$seuzFileNameSpecific     = "zoolrunneruninstall.zip";
...
$versionLanguage               = "en";
$ENV{WIZ_nameCompany}          = "ZoolRunner";
$ENV{WIZ_nameProduct}          = "ZoolRunner";
$ENV{WIZ_nameProductInternal}  = "ZoolRunner"; # product name without the version string
$ENV{WIZ_fileMainExe}          = "ZoolRunner.exe";
